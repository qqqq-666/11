...
- 🎯 Entry points to execute your program using `python -m <11>` or `$ 11` with basic CLI argument parsing.
...
Awesome 11 created by qqqq-666
...
```bash
git clone https://github.com/qqqq-666/11 11
cd 11
make install
```
...
```bash
11 create-db   # run once
11 populate-db  # run once (optional)
11 add-user -u admin -p 1234  # ads a user
11 run
```
