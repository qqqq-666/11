...
original_author="qqqq-666"
original_name="11"
original_urlname="11"
original_description="Awesome 11 created by qqqq-666" 
...
then
    ...
    echo "then run '11' or 'python -m 11'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run '11' or 'python -m 11' or 'poetry run 11'"
fi
